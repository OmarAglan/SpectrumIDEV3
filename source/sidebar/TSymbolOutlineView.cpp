...
TSymbolOutlineView::TSymbolOutlineView(QWidget *parent)
    : QWidget(parent)
{
    ...
    connect(m_filter, &QLineEdit::textChanged,
            this, &TSymbolOutlineView::applyFilter);
...
void TSymbolOutlineView::setSymbols(
...
void TSymbolOutlineView::clearSymbols()
{
    m_filePath.clear();
    m_tree->clear();
...
void TSymbolOutlineView::setFilterText(const QString &text)
{
    m_filter->setText(text);
}

void TSymbolOutlineView::appendSymbol(
...
bool TSymbolOutlineView::filterItem(
...
void TSymbolOutlineView::applyFilter()
{
...
void TSymbolOutlineView::activateItem(QTreeWidgetItem *item)
{
