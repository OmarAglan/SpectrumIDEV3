...
QalamFlatButton::QalamFlatButton(QWidget *parent, QString label)
    : QPushButton(parent) {
    setFlat(true);
...
void QalamFlatButton::enterEvent(QEnterEvent *event) {
    QPushButton::enterEvent(event);
    startHoverAnimation(1.0);
}

void QalamFlatButton::leaveEvent(QEvent *event) {
    QPushButton::leaveEvent(event);
    startHoverAnimation(0.0);
}

void QalamFlatButton::paintEvent(QPaintEvent *event) {
    Q_UNUSED(event)
...
void QalamFlatButton::startHoverAnimation(qreal targetValue) {
