...
QVector<CommandRegistry::Command> CommandRegistry::defaultCommands()
{
    return {
        ...
        {"editor.splitRight", "محرر: تقسيم إلى اليمين", "عرض المستند الحالي في مجموعة إلى اليمين", "Ctrl+\\"},
        {"editor.splitLeft", "محرر: تقسيم إلى اليسار", "عرض المستند الحالي في مجموعة إلى اليسار", ""},
        {"editor.splitDown", "محرر: تقسيم إلى الأسفل", "عرض المستند الحالي في مجموعة سفلية", ""},
        {"editor.splitUp", "محرر: تقسيم إلى الأعلى", "عرض المستند الحالي في مجموعة علوية", ""},
        {"editor.moveRight", "محرر: نقل إلى المجموعة اليمنى", "نقل علامة التبويب الحالية إلى اليمين", ""},
        {"editor.moveLeft", "محرر: نقل إلى المجموعة اليسرى", "نقل علامة التبويب الحالية إلى اليسار", ""},
        {"editor.moveDown", "محرر: نقل إلى المجموعة السفلية", "نقل علامة التبويب الحالية إلى الأسفل", ""},
        {"editor.moveUp", "محرر: نقل إلى المجموعة العلوية", "نقل علامة التبويب الحالية إلى الأعلى", ""},
        {"editor.closeGroup", "محرر: إغلاق مجموعة التحرير الثانوية", "إعادة تبويبات المجموعة الثانوية إلى المجموعة الرئيسية", ""},
        ...
        {"code.workspaceSymbols", "الشفرة: رموز مساحة العمل", "البحث الدلالي في رموز مشروع تكوين", "Ctrl+T"},
        ...
        {"code.expandSelection", "الشفرة: توسيع التحديد الدلالي", "توسيع التحديد إلى البنية التالية التي يحددها مترجم باء", "Shift+Alt+Right"},
        {"code.shrinkSelection", "الشفرة: تقليص التحديد الدلالي", "الرجوع إلى التحديد البنيوي السابق", "Shift+Alt+Left"},
        {"project.build", "تشغيل: بناء المشروع أو ملف نظم", "بناء مشروع تكوين أو تجميع ملف نظم مستقل", "Ctrl+Shift+B"},
        {"project.test", "تشغيل: اختبار مشروع تكوين", "تشغيل أهداف الاختبار عبر تكوين", ""},
        {"run.baa", "تشغيل: تشغيل ملف باء أو نظم", "حفظ وربط وتشغيل الملف الحالي أو مشروع تكوين", "F5"},
